  ...
  try {
    ...
    if (!row || row.count === 0) {
      const defaultPartis = [
        ...
        { code: 'FJSA', nom: 'Parti de la Liberté et de la Justice Sociale', nom_ar: 'حزب الحرية والعدالة الاجتماعية', sigle_ar: 'حرية وعدالة', couleur: '#DC2626', tete: 'Candidat FJSA Tan-Tan', ordre: 4 },
        ...
        { code: 'PND', nom: 'Parti des Nouveaux Démocrates', nom_ar: 'حزب الديمقراطيين الجدد', sigle_ar: 'ديمقراطيون جدد', couleur: '#B91C1C', tete: 'Candidat PND Tan-Tan', ordre: 9 },
